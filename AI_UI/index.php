    ...
    <div class="row g-4">
      <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
        <div class="p-4 h-100 bg-white rounded-3 shadow-sm text-center">
          ...
          <p>We believe quality is the foundation of trust. Our beverages are made with carefully selected ingredients.
          </p>
        </div>
      </div>
      <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
        <div class="p-4 h-100 bg-white rounded-3 shadow-sm text-center">
          ...
          <p>Innovation drives us forward. Our dedicated R&D team continuously works to create new flavors.</p>
        </div>
      </div>
      <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
        <div class="p-4 h-100 bg-white rounded-3 shadow-sm text-center">
          ...
          <p>Our state-of-the-art production facility is equipped with advanced machinery and automation.</p>
        </div>
      </div>
    </div>
